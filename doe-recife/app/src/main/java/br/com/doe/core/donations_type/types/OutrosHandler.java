 ...
 * 
 */
public class OutrosHandler extends DonationHandler {
	 ...
	 * @param context
	 */
	public OutrosHandler(int id, Context context) {
		super(id, context, context.getResources().getString(R.string.outros));
		this.ctx = context;
	}
	...
	public void handle(String donationType, Context ctx, User user) {
		...
		if (donationType.equals(getResources().getString(R.string.outros))) {
			mUser = user;
	...
	public void onClick(View v) {
		...
		intent.putExtra(getResources().getString(R.string.user),
				createFilterUser(mUser,getResources().getString(
						R.string.outros)));
		intent.putExtra(getResources().getString(R.string.donation_id),
				R.drawable.ic_outros_blue);
